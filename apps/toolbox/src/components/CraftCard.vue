...
<template>
  ...
  >
    <div class="flex items-start gap-3">
      <span
        class="flex size-9 shrink-0 items-center justify-center rounded-md bg-primary-soft text-primary"
      ...
      <div class="min-w-0 flex-1">
        <span class="block text-[9px] font-bold tracking-[0.16em] text-muted-foreground uppercase"
          >Craft</span
        >
        <h3 class="mt-0.5 font-semibold text-foreground">{{ craft.meta.title[lang] }}</h3>
      </div>
      <AppIcon
